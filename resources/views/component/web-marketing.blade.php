<div class='webdisplay'>
    ...
    <div class='webmark2'>
        <div class='webmarpp'>
            <h1 class='headweb'>We Lead from the Front</h1>
            <div class='normwebtxt'>
                <p>
        ...
        <div class='textingweb'>
            <div class='rightarrowweb'>
                <span class='rightarrweb'>
                    <span class='rightweb'></span>
                </span> <span class='ecosystem'>
