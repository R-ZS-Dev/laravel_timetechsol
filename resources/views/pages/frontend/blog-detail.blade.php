...
@section('mainContent')
    ...
    <div class='left_and_right'>
        <div class='left_side'>
            <div class='pading'>
                <div>
                    <Image class='seo_new_img' src='/upload/image/seeseo.jpg' height='420' width='500' alt=''>
                    </Image>
                </div>
                    ...
                    <div class='icon_div_left'>
                        <div class='left_padd'>
                            <span class='bd_text_font'>
                                <Image class='pad_three' src='/upload/image/user.png' height='20' width='20'
                                    alt=''></Image> Lilian Corner
                                <Image class='pad_three' src='/upload/image/clock.png' height='20' width='20'
                                    alt=''></Image> March 15, 2019
                                <Image class='pad_three' src='/upload/image/comment.png' height='20' width='20'
                                    alt=''></Image> 13
                            </span>
                        </div>
                    </div>
                    <p class='icon_div_right'>
                        <Image class='soc_icon' src='/upload/image/fb.png' height='30' width='30' alt=''>
                        </Image>
                        <Image class='soc_icon' src='/upload/image/tw.png' height='30' width='30' alt=''>
                        </Image>
                        <Image class='soc_icon' src='/upload/image/gplus.png' height='30' width='30' alt=''>
                        </Image>
                        <Image class='soc_icon' src='/upload/image/ln.png' height='30' width='30' alt=''>
                        </Image>
                        <Image class='soc_icon' src='/upload/image/pn.png' height='30' width='30' alt=''>
                        </Image>
                    </p>
                </div>
            </div>
            ...
            <div class='content_img_width'>
                <div class='content_img_left'>
                    ...
                    <p class='p_lin_height'>
                        ...
                        tyessentiall year unchanged. It was popularised in the with the release of Letraset sheets
                        containing Lorem Ipsum passages, and more recently with desktop publishing
                    </p>
                </div>
                <div class='content_img_right'>
                    <span>
                        <Image class='content_img_sizing' src='/upload/image/blog24.jpg' height='250' width='150'
                            alt=''></Image>
                    </span>
                </div>
            </div>
            ...
            <div class='heading_two'>
                ...
                <label class='heading_three_tick'>
                    <Image class='tick_icon' src='upload/image/tick.png' height='20' width='20' alt=''>
                    </Image>
            ...
            <div class='author_box'>
                <Image class='author_pic' src='/upload/image/authorpic.jpg' height='80' width='80'
                    alt=''></Image>
                <div class='author_name'>
                    <label><strong class='author_nam'>Lora Zaman</strong>
                        <span class='author_icons'>
                            <Image class='auth_circle' src='/upload/image/fb.png' height='30' width='30'
                                alt=''></Image>
                            <Image class='auth_circle' src='/upload/image/tw.png' height='30' width='30'
                                alt=''></Image>
                            <Image class='auth_circle' src='/upload/image/ln.png' height='30' width='30'
                                alt=''></Image>
                            <Image class='auth_circle' src='/upload/image/gplus.png' height='30' width='30'
                                alt=''></Image>
                        </span>
                    </label>
                    <div>Author</div>
                    <p class='author_text'>
                        Dorem ipsum dolor sit amet, consectetuer adipiscing elit,sed diam nonummy nibh euismod tincidunt ut
            ...
            <div class='next_previous'>
                <div class='previous_side'>
                    <Image class='previous_radious' src='/upload/image/blog13.jpg' height='140' width='160'
                        alt=''></Image>
                    <div class='previous_side_padding'>
                        ...
                        <div class='previous_topmargin'>
                            <Image class='previous_clock' src='/upload/image/clock.png' height='30' width='30'>
                            </Image>
                ...
                <div class='next_side'>
                    <div class='right_half_width'>
                        <div class='right_width_less'>
                            ...
                            <div>
                                <Image class='Next_clock' src='/upload/image/clock.png' height='30' width='30'>
                                </Image>
                        ...
                        <Image class='next_radious' src='/upload/image/blog13.jpg' height='140' width='160'
                            alt=''></Image>
                    </div>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class='comment_reply'>
                        <div class='comment_right_side'>
                            <Image class='com_img_radius' src='/upload/image/user1.jpg' height='100' width='100'>
                            </Image>
                        </div>
                        <div class='comment_left_side'>
                            <strong>John Doe
                                <Link class='comment_reply_right' href=''>Reply</Link>
                            </strong>
                            <div>
                    ...
                    <div class='comment_reply1'>
                        <div class='comment_right_side'>
                            <Image class='com_img_radius' src='/upload/image/user2.jpg' height='100' width='100'>
                            </Image>
                        </div>
                        <div class='comment_left_side'>
                            <strong>Maria Jaman
        ...
        <div class='right_side'>
            <x-blog-detail-right></x-blog-detail-right>
        </div>
    </div>
@endsection
@section('jsLinks')
